...
For the example it currently is counting down to Jan. 1, 2019. This can be any date by updating the `to` prop on the
Countdown component within `src/App.js`, as long as it is a [Date object](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date).

Styling for the components can be found within `src/App.css`.
